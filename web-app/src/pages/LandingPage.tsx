          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6 sm:gap-12 md:gap-20">
            ...
            <div className="text-center">
              <div className="flex items-baseline justify-center gap-1">
                <span className="text-4xl sm:text-5xl font-bold text-primary-600">1,000</span>
                <span className="text-2xl sm:text-3xl font-bold text-primary-500">+</span>
              </div>
              <p className="text-gray-600 text-sm sm:text-base mt-1">completed cuts nationwide</p>
            </div>
            ...
            <div className="text-center">
              <div className="flex items-baseline justify-center gap-1">
                <span className="text-4xl sm:text-5xl font-bold text-primary-600">100</span>
                <span className="text-2xl sm:text-3xl font-bold text-primary-500">+</span>
              </div>
              <div className="flex items-center justify-center gap-1 mt-1">
                ...
                <span className="text-gray-600 text-sm sm:text-base">reviews per campus</span>
              </div>
            </div>
          </div>
        </div>
