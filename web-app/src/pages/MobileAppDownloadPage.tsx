 ...
 * 
 * Native-style app install experience for TivelaPlatforms dApp
 * Features:
        ...
        <div className="max-w-md w-full">
          <div className="bg-white rounded-3xl p-8 shadow-2xl text-center animate-slide-up">
            ...
            <p className="text-gray-600 mb-8">
              TivelaPlatforms is installed and ready to use. Access it from your home screen anytime!
            </p>
