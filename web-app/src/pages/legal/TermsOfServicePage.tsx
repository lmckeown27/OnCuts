        ...
        <div className="bg-white rounded-lg shadow p-8 md:p-12">
          ...
          <div className="space-y-8 text-gray-700 leading-relaxed">
            <section>
              ...
              <p>
                Welcome to TivelaPlatforms (&quot;we,&quot; &quot;our,&quot; or &quot;us&quot;). These Terms of Service
                (&quot;Terms&quot;) govern your access to and use of the TivelaPlatforms platform, including our website,
                the TivelaPlatforms iOS app for consumers, the Tivela - Provider iOS app for barbers, and all related services
            ...
            <section>
              ...
              <p>
                TivelaPlatforms is a marketplace platform that connects consumers seeking grooming services
              ...
              <p className="mt-3">
                <strong>Important:</strong> TivelaPlatforms is a platform that connects users. We are not a grooming service
                provider. Barbers are independent contractors, not employees of TivelaPlatforms.
              </p>
              <p className="mt-3">
                Consumers may use the TivelaPlatforms iOS app or our website. Barbers manage bookings, availability,
                messaging, and payouts through the Tivela - Provider iOS app and/or the barber web dashboard, where
                available.
              </p>
            </section>
            ...
            <section>
              ...
              <ul className="list-disc pl-6 mt-2 space-y-1">
                <li>Submit an application and receive approval from TivelaPlatforms administrators before offering services</li>
            ...
            <section>
              ...
              <p>
                ...
                receives a payment prompt in the TivelaPlatforms app or on the web.
              </p>

              <p className="font-semibold mt-4 mb-2">6.3 Platform Fee and Barber Payouts</p>
              <p>
                TivelaPlatforms charges a 15% platform fee on the service amount for completed bookings. Barbers receive 85%
            ...
            <section>
              ...
              <p className="mt-3">
                ...
                Consumers and Barbers should first be resolved directly. TivelaPlatforms may assist in mediation but is not
            ...
            <section>
              ...
              <p>
                The Service and its original content, features, and functionality are owned by TivelaPlatforms and are
                protected by international copyright, trademark, patent, trade secret, and other intellectual property
                laws.
              </p>
              <p className="mt-3">
                By posting User Content, you grant TivelaPlatforms a non-exclusive, worldwide, royalty-free license to use,
            ...
            <section>
              ...
              <p>
                You agree to indemnify, defend, and hold harmless TivelaPlatforms and its officers, directors, employees,
