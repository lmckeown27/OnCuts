                  ...
                  <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4">
                    ...
                    {adminDashboardCampusId && campusBarbersForManager.length > 0 && (
                      <div className="flex items-center gap-2 p-2 bg-gray-50 rounded-lg border border-gray-200">
                        <p className="text-xs font-semibold text-gray-700 whitespace-nowrap">Campus Manager</p>
                        <select
                          value={selectedCampusManagerId}
                          onChange={(e) => handleCampusManagerChange(e.target.value)}
                          disabled={isAssigningCampusManager}
                          className="text-sm border border-gray-300 rounded-lg px-2 py-1.5 bg-white focus:outline-none focus:ring-2 focus:ring-primary-500 disabled:opacity-50"
                        >
