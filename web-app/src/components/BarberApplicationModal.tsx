      ...
      >
        ...
        >
          ...
          <p className="text-gray-600 mb-6">
            Your application has been submitted. The TivelaPlatforms team will be in touch with you shortly.
          </p>
          <button
            onClick={handleCloseSuccessPopup}
      ...
      >
        ...
        >
          ...
          <div className="p-6 text-center">
            ...
            <p className="text-gray-600 mb-6">
              Your barber privileges have been removed by the TivelaPlatforms team. You no longer have access to the barber dashboard or booking features.
            </p>
            ...
            <div className="border-t pt-5">
              ...
              <a 
                href="mailto:avilaplatformshelp@gmail.com?subject=Barber Access Removed - Appeal"
                target="_blank"
  ...
  if (existingApplication) {
    const statusMessages: Record<string, { title: string; description: string; color: string }> = {
      pending: {
        ...
        description: 'Your application has been submitted and is currently being reviewed by the TivelaPlatforms team. They will get back to you once they\'ve reviewed your application.',
        color: 'amber'
      },
      under_review: {
        title: 'Application Under Review',
        description: 'Your application is actively being reviewed by the TivelaPlatforms team. They will reach out to you soon with next steps.',
        color: 'blue'
      },
      interview_scheduled: {
    ...
    >
      ...
      >
        ...
        <div className="bg-gradient-to-r from-gray-900 to-gray-800 px-6 py-4 flex items-center justify-center relative flex-shrink-0">
          <div className="flex flex-col items-center text-center">
            <h2 className="text-xl font-bold text-white">Become a TivelaPlatforms Barber</h2>
          ...
          {step === 1 ? (
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 mb-2">
                  The TivelaPlatforms team may reach out to you via text or call.
                </p>
                <input
                  type="tel"
                  inputMode="numeric"
            ...
            <div className="space-y-6">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600 mt-1">
                      The TivelaPlatforms team may verify your license before approving your application. Provide accurate
              ...
              <div>
                ...
                {form.licenseDeclared === 'no' && (
                  <p className="text-sm text-amber-800 bg-amber-50 border border-amber-200 rounded-lg p-3 mt-3">
                    You may still apply, but the TivelaPlatforms team may require a license before you can accept bookings.
                  </p>
                )}
              </div>
              ...
              {form.licenseDeclared === 'yes' && (
                <div>
                  ...
                  <p className="text-xs text-gray-500 mt-2">
                    Enter the number exactly as it appears on your license. The TivelaPlatforms team may request a photo
                    for verification.
                  </p>
                </div>
              )}
              ...
              <label className="flex items-start gap-3 p-4 rounded-xl border border-gray-200 bg-gray-50 cursor-pointer">
                ...
                <span className="text-sm text-gray-700">
                  ...
                  understand that TivelaPlatforms may verify it before I am approved to provide
                  services.
                </span>
              </label>
            </div>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-primary-50 border-2 border-gray-200 rounded-xl p-4">
                ...
                <p className="text-xs text-gray-600 mb-3">
                  Your application will be sent to the TivelaPlatforms team at this location.
                </p>
                {loadingCampuses ? (
              ...
              <div>
                <label className="block text-sm font-semibold text-gray-700 mb-2">
                  Why do you want to be a TivelaPlatforms barber? *
                </label>
                <textarea
                  value={form.whyBeBarber}
                  onChange={(e) => setForm({ ...form, whyBeBarber: e.target.value })}
                  placeholder="Tell us about your passion for barbering and why you'd be a great fit for TivelaPlatforms..."
                  rows={4}
            ...
            <div className="space-y-6">
              ...
              <div className="bg-gray-50 rounded-lg p-4 space-y-4">
                ...
                <div className="border-t pt-4">
                  <p className="text-xs text-gray-500 uppercase tracking-wide mb-2">Why TivelaPlatforms?</p>
