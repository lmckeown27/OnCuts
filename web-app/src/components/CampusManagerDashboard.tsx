...
export const CampusManagerDashboard: React.FC<CampusManagerDashboardProps> = ({ 
  ...
  const [activeTab, setActiveTab] = useState<'applications' | 'barbers' | 'content' | 'bookings'>('applications');
  ...
  return (
    <div className="space-y-4 sm:space-y-6">
      ...
      >
        ...
        {displayedTab === 'content' && <ContentManagementPanel campusId={campusId} instagramHandle={instagramHandle} />}
...
const ContentManagementPanel: React.FC<{ campusId: string; instagramHandle?: string }> = ({ campusId, instagramHandle }) => {
  const hasInstagram = instagramHandle && instagramHandle.trim() !== '';
  const instagramUrl = hasInstagram ? `https://www.instagram.com/${instagramHandle}/` : '';
      ...
      <Card className="p-5 sm:p-8">
        <div className="text-center">
          ...
          {hasInstagram ? (
            ...
            <>
              <p className="text-base sm:text-lg text-gray-500 mb-1 italic">
                No Instagram handle set
              </p>
              <p className="text-xs sm:text-sm text-gray-400 mb-4 sm:mb-6 max-w-md mx-auto">
                Contact the admin to set up an Instagram handle for this campus.
              </p>
            </>
          )}
        </div>
