      ...
      >
        ...
        <div className="p-6">
          <p className="text-gray-700 text-center mb-4">
            TivelaPlatforms needs your location to show you the <strong>closest barbers</strong> on your campus.
          </p>
          ...
          <p className="text-xs text-gray-500 text-center mb-6">
            Your location is only used while using TivelaPlatforms and is never shared with third parties.
          </p>
