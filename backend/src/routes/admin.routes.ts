...
router.get('/campuses/aggregate/metrics/events/options', adminController.getAggregateMetricsEventsOptions);
...
router.get('/campuses/:campusId/metrics/events/options', adminController.getCampusMetricsEventsOptions);
...
router.put('/barbers/:barberRecordId/visibility', adminController.updateBarberVisibility);
