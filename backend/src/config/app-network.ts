 ...
 * Note: APP_NETWORK_MODE=testnet + STRIPE_MODE=auto + sk_live STRIPE_SECRET_KEY without
 * STRIPE_SECRET_KEY_TEST still resolves Stripe to live keys (see stripe.ts; not gated on NODE_ENV).
 */
